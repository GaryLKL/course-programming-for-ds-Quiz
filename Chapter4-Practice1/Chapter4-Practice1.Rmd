...
**這筆資料集來自IMDB，為2014年至2017年電影排行（根據熱門程度排名），總共蒐集了7200部電影。**
...
```{r Prac5Quiz1, exercise = TRUE, exercise.lines = 10, exercise.eval = TRUE, message  = FALSE}
library(readr)
...
```{r Prac5Quiz2, exercise = TRUE, exercise.lines = 10, exercise.eval = TRUE, message  = FALSE}
library(readr)
IMDBData <- read_csv("https://raw.githubusercontent.com/GaryLKL/course-programming-for-ds-Quiz/master/imdb_movies.csv")
...
**1. 請幫我將「類型」轉成factor**
**2. 「類型」總共有幾類呢？**
**3. 參考電子書5.4.7，請幫我創造一個一個新的變數「片長分類」，將原變數「片長」轉成factor後，level設定為：0~90、90~120、120~150、150以上**

```{r Prac5Quiz3, exercise = TRUE, exercise.lines = 10, exercise.eval = TRUE, message  = FALSE}
library(readr)
IMDBData <- read_csv("https://raw.githubusercontent.com/GaryLKL/course-programming-for-ds-Quiz/master/imdb_movies.csv")
