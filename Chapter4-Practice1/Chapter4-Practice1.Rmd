...
## Practice 2 
下方資料來自：[颱風資料庫](http://rdc28.cwb.gov.tw/TDB/ntdb/pageControl/typhoon)  
...
\
步驟一：  
請用stringr套件的str_sub函數提出前4位數字

步驟二：  
請用table函數計算各月份的颱風警報頻率
...
**(參考電子書4.7章節)**  
步驟一：  
使用lubridate套件的ymd_hm函數，將Time轉成時間格式(POSIXct)  
步驟二：  
使用years函數，減去1911年
...
```{r Prac2Quiz2-hint}
ymd_hm("1958-07-13 12:00") - years(1911)
```
